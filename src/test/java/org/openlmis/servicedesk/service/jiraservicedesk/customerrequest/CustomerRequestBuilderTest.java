...
public class CustomerRequestBuilderTest {
  ...
  private String email = "test@openlmis.org";
  private String publicUrl = "https://siglofa.org";
  ...
  public void setUp() {
    ...
    ReflectionTestUtils.setField(customerRequestBuilder, "publicUrl", publicUrl);
  }
  ...
  private String getDescriptionWithMetadata() {
    return String.format("%s %n%n[METADATA]%nUsername: %s%nEmail: %s%nURL: %s",
