...
public class UserContactDetailsDtoTest {
  ...
  public void shouldImplementToString() {
    UserContactDetailsDto userContactDetails = new UserContactDetailsDtoDataBuilder().build();
    ToStringTestUtils.verify(UserContactDetailsDto.class, userContactDetails);
  }
}
